...
class Auth_Mdl extends CI_Model {
    ...
    //permet faire de modifier l'attribut only d'un utilisateur 
    function user_is_online($id,$online){
        $this->db->set(array('online'=>$online));
        $this->db->where('id',$id)->update($this->getTable('user'));
    }
